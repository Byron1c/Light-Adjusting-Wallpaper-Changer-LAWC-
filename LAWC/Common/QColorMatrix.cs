...
namespace Img
{
    ...
    public class QColorMatrix
    {
        ...
        private readonly float[,] m = new float[MatrixLength, MatrixLength];
        ...
        */
        ...
        internal const float lumR = 0.3086f;
        internal const float lumG = 0.6094f;
        internal const float lumB = 0.0820f;
        ...
        /// gdi+ type
        /// </summary>
        public enum MatrixOrder2 { MatrixOrderPrepend = 0, MatrixOrderAppend = 1 };
        ...
        public static Color Vector2Color(float[] p)
        {
            ...
            {
                throw new ArgumentException("Vector2Color");
            }
        ...
        public float[] TransformVector(float[] v, bool normalize)
        {
            ...
            {
                throw new ArgumentException("TransformVector");
            }
        ...
        {
            Multiply(matrix, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            if (matrix == null) throw new ArgumentException("Multiply");
            float[,] a;
            float[,] b;
            ...
            float scaleOpacity)
        {
            Scale(scaleRed, scaleGreen, scaleBlue,
                scaleOpacity, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            ScaleColors(scale, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            ScaleOpacity(scaleOpacity, MatrixOrder2.MatrixOrderPrepend);
        }
            ...
            float offsetOpacity)
        {
            Translate(offsetRed, offsetGreen, offsetBlue,
                offsetOpacity, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            TranslateColors(offset, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            TranslateOpacity(offsetOpacity, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            RotateRed(phi, MatrixOrder2.MatrixOrderPrepend);
        }
        public void RotateGreen(float phi)
        {
            RotateGreen(phi, MatrixOrder2.MatrixOrderPrepend);
        }
        public void RotateBlue(float phi)
        {
            RotateBlue(phi, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            ShearRed(green, blue, MatrixOrder2.MatrixOrderPrepend);
        }

        public void ShearGreen(float red, float blue)
        {
            ShearGreen(red, blue, MatrixOrder2.MatrixOrderPrepend);
        }

        public void ShearBlue(float red, float green)
        {
            ShearBlue(red, green, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        {
            SetSaturation(saturation, MatrixOrder2.MatrixOrderPrepend);
        }
        ...
        public void RotateHue(float phi)
        {
            ...
            Multiply(preHue, MatrixOrder2.MatrixOrderAppend);
            // Rotate around the blue axis
            RotateBlue(phi, MatrixOrder2.MatrixOrderAppend);
            Multiply(postHue, MatrixOrder2.MatrixOrderAppend);
        }
        ...
        {
            TranslateColors(offset, MatrixOrder2.MatrixOrderAppend);
        }

        public void SetSaturation2(float saturation)
        {
            SetSaturation(saturation, MatrixOrder2.MatrixOrderAppend);
        }
        ...
        {
            return Scale2(scaleRed, scaleGreen, scaleBlue, 1.0f);
        }
        ...
        /// <returns>True if successfull, otherwise false</returns>
        public bool Scale2(float scaleRed, float scaleGreen, float scaleBlue, float scaleOpacity)
        {
            try
            {
                QColorMatrix qm = new QColorMatrix();

                qm.Matrix[0, 0] = scaleRed;
                qm.Matrix[1, 1] = scaleGreen;
                qm.Matrix[2, 2] = scaleBlue;
                qm.Matrix[3, 3] = scaleOpacity;

                //ORIGINAL: this.SetColorMatrix(new ColorMatrixExt(this * dcmtx));

                this.Multiply(qm);
                //this.SetColorMatrix(new QColorMatrix(qm.Matrix));
                this.SetColorMatrix(this);
            }
        ...
        private void SetColorMatrix(QColorMatrix clrmtx)
        {
            for (int i = 0; i < 5; i++)
            {
                for (int j = 0; j < 5; j++)
                {
                    this.Matrix[i, j] = clrmtx.Matrix[i, j];
                }
            }
        }
        ...
        private static void InitHue()
        {
            ...
            if (!initialized)
            {
                ...
                preHue.RotateGreen(-greenRotation, MatrixOrder2.MatrixOrderAppend);
                ...
                preHue.ShearBlue(red, green, MatrixOrder2.MatrixOrderAppend);
                ...
                postHue.RotateGreen(greenRotation, MatrixOrder2.MatrixOrderAppend);
                postHue.RotateRed(-45.0f, MatrixOrder2.MatrixOrderAppend);
            }
        }
