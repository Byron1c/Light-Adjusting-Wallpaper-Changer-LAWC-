...
namespace LAWC
{
    internal class Constants
    {
        ...
        internal const String EmailAccountUser = "tgrowden@gmail.com";
        internal const String EmailAccountPass = "dubluekbyhxwhskm";
        internal const String EmailSMTP = "smtp.gmail.com";
        internal const int EmailSMTPPort = 587;

        internal const String ErrorFromEmail = "tgrowden@gmail.com";
        internal const String ErrorToEmail = "troy@strangetimez.com";

        internal const String OpenWeatherAPIKey = "10c57f3868d135d48fa9e22acdcdeaf7";
